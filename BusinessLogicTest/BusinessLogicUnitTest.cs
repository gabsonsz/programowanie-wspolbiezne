...
namespace TP.ConcurrentProgramming.BusinessLogic.Test
{
    ...
    public class BusinessLogicImplementationUnitTest
    {
        ...
        private class DataLayerConstructorFixcure : Data.DataAbstractAPI
        {
            ...
            public override void Start(int numberOfBalls, Action<IVector, Data.IBall> upperLayerHandler,IDataLogger logger)
            {
        ...
        private class DataLayerStartFixcure : Data.DataAbstractAPI
        {
            ...
            public override void Start(int numberOfBalls, Action<IVector, Data.IBall> upperLayerHandler, IDataLogger loger)
            {
                StartCalled = true;
